...
class MockTagManager implements TagManager {
  ...
  @Override
  public boolean canCreateTagByTitle(String tagTitlePath)
      throws InvalidTagFormatException {
    throw new UnsupportedOperationException("Unsupported operation");
  }

  @Override
  public boolean canCreateTagByTitle(String tagTitlePath, Locale locale)
      throws InvalidTagFormatException {
    throw new UnsupportedOperationException("Unsupported operation");
  }
  ...
  @Override
  public Tag createTagByTitle(String titlePath) throws AccessControlException,
      InvalidTagFormatException {
    return createTagByTitle(titlePath, true);
  }

  @Override
  public Tag createTagByTitle(String titlePath, boolean autoSave)
      throws AccessControlException, InvalidTagFormatException {
    throw new UnsupportedOperationException("Unsupported operation");
  }

  @Override
  public Tag createTagByTitle(String titlePath, Locale locale)
      throws AccessControlException, InvalidTagFormatException {
    throw new UnsupportedOperationException("Unsupported operation");
  }
  ...
  @Override
  public void mergeTag(Tag tag, Tag destination) throws AccessControlException,
      TagException {
    throw new UnsupportedOperationException("Unsupported operation");
  }

  @Override
  public Tag moveTag(Tag tag, String destination) throws AccessControlException,
      InvalidTagFormatException, TagException {
    throw new UnsupportedOperationException("Unsupported operation");
  }
