...
public final class MockJcr {
   ...
   * Beware: each session has its own data store.
  ...
  /**
   * Create a new mocked in-memory JCR session. It contains only the root node.
   * All data of the session is thrown away if it gets garbage collected.
   * @return JCR session
   */
